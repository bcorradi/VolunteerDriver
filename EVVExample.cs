...
namespace EdiFabric.Examples.X12.T837P
{
    class EVVExample
    {
        ...
        /// Write Claim
        /// </summary>
        public static void Write(List<Claim> claims)
        {
        ...
        public static TS837P BuildClaim(string controlNumber)
        {
            ...
            result.BHT_BeginningofHierarchicalTransaction.SubmitterTransactionIdentifier_03 = "244579"; //bjc have to change this to something
            result.BHT_BeginningofHierarchicalTransaction.TransactionSetCreationDate_04 = DateTime.Now.Date.ToString("yyMMdd");
            result.BHT_BeginningofHierarchicalTransaction.TransactionSetCreationTime_05 = DateTime.Now.TimeOfDay.ToString("hhmm");
            ...
            result.AllNM1.Loop1000A.NM1_SubmitterName.ResponseContactLastorOrganizationName_03 = "AEOA";
