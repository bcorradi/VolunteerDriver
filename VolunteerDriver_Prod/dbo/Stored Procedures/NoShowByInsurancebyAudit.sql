...
create procedure [dbo].[NoShowByInsurancebyAudit] (@insuranceid int, @startdate datetime, @enddate datetime)
as
set nocount on
...
and NoShow = 1
and r.Canceled = 0
--need to get old rides that where marked as noshow in daterange
