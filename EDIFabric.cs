...
namespace EdiFabric.Examples.X12.T837P
{
    public class EDIFabric
    {
        ...
        /// Write Claim
        /// </summary>
        public static void Write(List<Claim> claims, _837StaticOutput _837Input)
        {
             //= BuildClaim("1", _837Input);
            ...
            {
                var separators = new Separators(Separators.X12.Segment, ':',
                Separators.X12.DataElement, Separators.X12.RepetitionDataElement, Separators.X12.Escape);

                //writer.Write(SegmentBuilders.BuildIsa(_837Input), separators);
                writer.Write(SegmentBuilders.BuildIsa("1"), separators);
                //writer.Write()
                //writer.Write(SegmentBuilders.BuildGS(_837Input));
                ...
                {
                    var transaction = BuildClaim("1", _837Input, c);
                    writer.Write(transaction);
                }       
            ...
            string ediString = stream.LoadToString();

            //FileStream file = new FileStream("d:\\test.txt", FileMode.Create, FileAccess.Write);
            ...
            System.IO.File.WriteAllText(@"D:\test.txt", ediString);
        ...
        public static TS837P WriteHeader()
        {
        ...
        /// </summary>
        public static TS837P BuildClaim(string controlNumber, _837StaticOutput input, Claim claim)
        {
            var result = new TS837P();            
            ...
            result.AllNM1.Loop1000A.NM1_SubmitterName.ResponseContactLastorOrganizationName_03 = "ARROWHEAD TRANSIT";
            result.AllNM1.Loop1000A.NM1_SubmitterName.IdentificationCodeQualifier_08 = "46";
            result.AllNM1.Loop1000A.NM1_SubmitterName.ResponseContactIdentifier_09 = "41-6052144";
            ...
            perLoop1000A.ResponseContactName_02 = "RYAN ZINTER";
            perLoop1000A.CommunicationNumberQualifier_03 = "TE";
            perLoop1000A.ResponseContactCommunicationNumber_04 = "2187356813";
            ...
            result.AllNM1.Loop1000B.NM1_ReceiverName.ResponseContactLastorOrganizationName_03 = "IGI HEALTH";
            result.AllNM1.Loop1000B.NM1_ReceiverName.IdentificationCodeQualifier_08 = "46";
            result.AllNM1.Loop1000B.NM1_ReceiverName.ResponseContactIdentifier_09 = "223387853";            
            ...
            loop2000A.PRV_BillingProviderSpecialtyInformation.ProviderTaxonomyCode_03 = "343900000X";
            ...
            loop2000A.AllNM1.Loop2010AA.NM1_BillingProviderName.ResponseContactLastorOrganizationName_03 = "ARROWHEAD TRANSIT";
            loop2000A.AllNM1.Loop2010AA.NM1_BillingProviderName.IdentificationCodeQualifier_08 = "XX";
            loop2000A.AllNM1.Loop2010AA.NM1_BillingProviderName.ResponseContactIdentifier_09 = "1801114301";
            ...
            loop2000A.AllNM1.Loop2010AA.N3_BillingProviderAddress.ResponseContactAddressLine_01 = "702 S  3RD AVE";
            ...
            loop2000A.AllNM1.Loop2010AA.N4_BillingProviderCity_State_ZIPCode.AdditionalPatientInformationContactCityName_01 = "VIRGINIA";
            loop2000A.AllNM1.Loop2010AA.N4_BillingProviderCity_State_ZIPCode.AdditionalPatientInformationContactStateCode_02 = "MN";
            loop2000A.AllNM1.Loop2010AA.N4_BillingProviderCity_State_ZIPCode.AdditionalPatientInformationContactPostalZoneorZIPCode_03 = "557922776";
            ...
            loop2000A.AllNM1.Loop2010AA.AllREF.REF_BillingProviderTaxIdentification.MemberGrouporPolicyNumber_02 = "416052144"; // member specific
            ...
            loop2000B.SBR_SubscriberInformation.InsuredGrouporPolicyNumber_03 = "18";
            loop2000B.SBR_SubscriberInformation.ClaimFilingIndicatorCode_09 = "MC";
            ...
            loop2000B.AllNM1.Loop2010BA.NM1_SubscriberName.ResponseContactLastorOrganizationName_03 = "PIKULA";
            loop2000B.AllNM1.Loop2010BA.NM1_SubscriberName.ResponseContactFirstName_04 = "ASHLEY";
            ...
            loop2000B.AllNM1.Loop2010BA.NM1_SubscriberName.ResponseContactIdentifier_09 = "726231251";

            loop2000B.AllNM1.Loop2010BA.N3_SubscriberAddress = new N3_AdditionalPatientInformationContactAddress();
            loop2000B.AllNM1.Loop2010BA.N3_SubscriberAddress.ResponseContactAddressLine_01 = "205 3RD STREET SOUTH";

            loop2000B.AllNM1.Loop2010BA.N4_SubscriberCity_State_ZIPCode = new N4_AdditionalPatientInformationContactCity();
            loop2000B.AllNM1.Loop2010BA.N4_SubscriberCity_State_ZIPCode.AdditionalPatientInformationContactCityName_01 = "VIRGINIA";
            loop2000B.AllNM1.Loop2010BA.N4_SubscriberCity_State_ZIPCode.AdditionalPatientInformationContactStateCode_02 = "MN";
            loop2000B.AllNM1.Loop2010BA.N4_SubscriberCity_State_ZIPCode.AdditionalPatientInformationContactPostalZoneorZIPCode_03 = "55792";
            ...
            loop2000B.AllNM1.Loop2010BA.DMG_SubscriberDemographicInformation.DependentBirthDate_02 = "19860421";
            loop2000B.AllNM1.Loop2010BA.DMG_SubscriberDemographicInformation.DependentGenderCode_03 = "U";
            ...
            loop2000B.AllNM1.Loop2010BB.NM1_PayerName.ResponseContactLastorOrganizationName_03 = "BLUE CROSS";
            loop2000B.AllNM1.Loop2010BB.NM1_PayerName.IdentificationCodeQualifier_08 = "PI";
            loop2000B.AllNM1.Loop2010BB.NM1_PayerName.ResponseContactIdentifier_09 = "A5143";

            loop2000B.AllNM1.Loop2010BB.N3_PayerAddress = new N3_AdditionalPatientInformationContactAddress();
            loop2000B.AllNM1.Loop2010BB.N3_PayerAddress.ResponseContactAddressLine_01 = "PO BOX 64560";

            loop2000B.AllNM1.Loop2010BB.N4_PayerCity_State_ZIPCode = new N4_AdditionalPatientInformationContactCity();
            loop2000B.AllNM1.Loop2010BB.N4_PayerCity_State_ZIPCode.AdditionalPatientInformationContactCityName_01 = "ST  PAUL";
            loop2000B.AllNM1.Loop2010BB.N4_PayerCity_State_ZIPCode.AdditionalPatientInformationContactStateCode_02 = "MN";
            loop2000B.AllNM1.Loop2010BB.N4_PayerCity_State_ZIPCode.AdditionalPatientInformationContactPostalZoneorZIPCode_03 = "551640560";
            ...
            loop2300.CLM_ClaimInformation.PatientControlNumber_01 = "121343-32494";
            loop2300.CLM_ClaimInformation.TotalClaimChargeAmount_02 = "12.75";
            loop2300.CLM_ClaimInformation.HealthCareServiceLocationInformation_05 = new C023_HealthCareServiceLocationInformation();
            loop2300.CLM_ClaimInformation.HealthCareServiceLocationInformation_05.FacilityTypeCode_01 = "99";
            ...
            loop2300.CLM_ClaimInformation.BenefitsAssignmentCertificationIndicator_08 = "N";
            loop2300.CLM_ClaimInformation.ReleaseofInformationCode_09 = "Y";
            ...
            loop2300.AllREF.REF_ClaimIdentifierForTransmissionIntermediaries.ReferenceIdentificationQualifier_01 = "G1";
            loop2300.AllREF.REF_ClaimIdentifierForTransmissionIntermediaries.MemberGrouporPolicyNumber_02 = "01-6102-A";
            ...
            loop2300.AllHI.HI_HealthCareDiagnosisCode.HealthCareCodeInformation_01.CodeListQualifierCode_01 = "ABK";
            loop2300.AllHI.HI_HealthCareDiagnosisCode.HealthCareCodeInformation_01.IndustryCode_02 = "R6889";

            loop2300.AllNM1 = new All_NM1_837P_3();
            loop2300.AllNM1.Loop2310C = new Loop_2310C_837P();

            loop2300.AllNM1.Loop2310C.NM1_ServiceFacilityLocationName = new NM1_OtherPayerServiceFacilityLocation();
            loop2300.AllNM1.Loop2310C.NM1_ServiceFacilityLocationName.EntityIdentifierCode_01 = "77";
            loop2300.AllNM1.Loop2310C.NM1_ServiceFacilityLocationName.EntityTypeQualifier_02 = "2";
            loop2300.AllNM1.Loop2310C.NM1_ServiceFacilityLocationName.ResponseContactLastorOrganizationName_03 = "ARROWHEAD CENTER INC";

            loop2300.AllNM1.Loop2310C.N3_ServiceFacilityLocationAddress = new N3_AdditionalPatientInformationContactAddress();
            loop2300.AllNM1.Loop2310C.N3_ServiceFacilityLocationAddress.ResponseContactAddressLine_01 = "505 S 12TH AVENUE WEST";

            loop2300.AllNM1.Loop2310C.N4_ServiceFacilityLocationCity_State_ZIPCode = new N4_AdditionalPatientInformationContactCity();
            loop2300.AllNM1.Loop2310C.N4_ServiceFacilityLocationCity_State_ZIPCode.AdditionalPatientInformationContactCityName_01 = "VIRGINIA";
            loop2300.AllNM1.Loop2310C.N4_ServiceFacilityLocationCity_State_ZIPCode.AdditionalPatientInformationContactStateCode_02 = "MN";
            loop2300.AllNM1.Loop2310C.N4_ServiceFacilityLocationCity_State_ZIPCode.AdditionalPatientInformationContactPostalZoneorZIPCode_03 = "557922001";
            ...
            //BJC need to loop through all the service lines
            ...
            loop24001.SV1_ProfessionalService.CompositeMedicalProcedureIdentifier_01.ProcedureCode_02 = "A0110";
            loop24001.SV1_ProfessionalService.CompositeMedicalProcedureIdentifier_01.ProcedureModifier_03 = "RD";
            
            loop24001.SV1_ProfessionalService.LineItemChargeAmount_02 = "1.75";
            ...
            loop24001.AllDTP.DTP_Date_ServiceDate.AccidentDate_03 = "20190826";

            loop24001.AllREF = new All_REF_837P_2();
            loop24001.AllREF.REF_LineItemControlNumber = new REF_LineItemControlNumber();
            loop24001.AllREF.REF_LineItemControlNumber.ReferenceIdentificationQualifier_01 = "6R";
            loop24001.AllREF.REF_LineItemControlNumber.MemberGrouporPolicyNumber_02 = "D1F10E4EB54CB1A9FEEE1DA4BD0015";
            ...
            loop24002.SV1_ProfessionalService.CompositeMedicalProcedureIdentifier_01.ProcedureCode_02 = "A0080";
            loop24002.SV1_ProfessionalService.CompositeMedicalProcedureIdentifier_01.ProcedureModifier_03 = "DR";

            loop24002.SV1_ProfessionalService.LineItemChargeAmount_02 = "1";
            ...
            loop24002.SV1_ProfessionalService.PlaceofServiceCode_05 = "11";
            ...
            loop24002.AllDTP.DTP_Date_ServiceDate.AccidentDate_03 = "20190826";


            loop24002.AllREF = new All_REF_837P_2();
            loop24002.AllREF.REF_LineItemControlNumber = new REF_LineItemControlNumber();
            loop24002.AllREF.REF_LineItemControlNumber.ReferenceIdentificationQualifier_01 = "6R";
            loop24002.AllREF.REF_LineItemControlNumber.MemberGrouporPolicyNumber_02 = "D1F10E4EB54CB1A9FEEE1DA4BD0015";
            ...
            loop24003.SV1_ProfessionalService.CompositeMedicalProcedureIdentifier_01.ProcedureCode_02 = "A0100";
            loop24003.SV1_ProfessionalService.CompositeMedicalProcedureIdentifier_01.ProcedureModifier_03 = "DR";

            loop24003.SV1_ProfessionalService.LineItemChargeAmount_02 = "1";
            ...
            loop24003.SV1_ProfessionalService.PlaceofServiceCode_05 = "11";
            loop24003.SV1_ProfessionalService.CompositeDiagnosisCodePointer_07 = new C004_CompositeDiagnosisCodePointer();
            loop24003.SV1_ProfessionalService.CompositeDiagnosisCodePointer_07.DiagnosisCodePointer_01 = "1";
            ...
            loop24003.AllDTP.DTP_Date_ServiceDate.AccidentDate_03 = "20190826";


            loop24003.AllREF = new All_REF_837P_2();
            loop24003.AllREF.REF_LineItemControlNumber = new REF_LineItemControlNumber();
            loop24003.AllREF.REF_LineItemControlNumber.ReferenceIdentificationQualifier_01 = "6R";
            loop24003.AllREF.REF_LineItemControlNumber.MemberGrouporPolicyNumber_02 = "04FCAD9A52483F98C026F470C6037C";
