...
insert into tblRide(ClientID, RPickUpAddress, RPickupCity, RPickupZip, County, --TripPurposeID
RideDate, RDropoffAddress, 
RDropoffCity, RDropoffZip, RDropoffCounty, --LoadedMiles, --MNDOTAllow
AuthCode, RepID, 
PickupFee, NoShowFee, TripID, InsuranceID, Rate, RideNotes, SchedulePickupTime, 
ScheduleApptTime, ReimburseRate, ReimburseRateID,RequireIDandAuth, MemberID, RequireAuthCode, SeqNo,ClientInsuranceID, FacilityName, RPickupZip4, 
RDropOffZip4,rDropOffState,rPickupState,PUAddressID,DOAddressID,PUAddressTypeID, DOAddressTypeID)
